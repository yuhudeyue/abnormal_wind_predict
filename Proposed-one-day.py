...
f = open('results_phace_space_8_6.txt', 'a')
save_folder = 'saved_model_2020_8_6'
filenames = os.listdir('new_phase_space_2020_8_6')
for filename in filenames:
    Y = h5py.File('new_phase_space_2020_8_6/'+filename)
    rMSE_total = 0
    acc_total = 0
