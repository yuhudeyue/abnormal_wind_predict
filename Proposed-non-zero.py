...
f = open('results_phace_space_7_28.txt', 'a')
save_folder = 'saved_model_2020_7_28'
filenames = os.listdir('new_phase_space_2020_7_28')
for filename in filenames:
    Y = h5py.File('new_phase_space_2020_7_28/'+filename)
    rMSE_total = 0
    acc_total = 0
