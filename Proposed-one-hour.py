...
f = open('results_phace_space_8_5.txt', 'a')
save_folder = 'saved_model_2020_8_5'
filenames = os.listdir('new_phase_space_2020_8_5')
for filename in filenames:
    Y = h5py.File('new_phase_space_2020_8_5/'+filename)
    rMSE_total = 0
    acc_total = 0
